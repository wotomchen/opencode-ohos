...
// HarmonyOS: node:worker_threads may not export markAsUncloneable
let markAsUncloneable
try {
  ({ markAsUncloneable } = require('node:worker_threads'))
} catch {
  markAsUncloneable = () => {}
}
