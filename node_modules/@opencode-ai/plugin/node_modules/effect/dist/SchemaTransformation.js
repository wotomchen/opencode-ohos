 ...
 * @since 4.0.0
 */
export const dateFromString = /*#__PURE__*/new Transformation(/*#__PURE__*/Getter.Date(), /*#__PURE__*/Getter.transform(formatDate));
/**
 ...
 * @since 4.0.0
 */
export const durationFromString = /*#__PURE__*/transformOrFail({
  decode: s => Option.match(Duration.fromInput(s), {
...
export const durationFromNanos = /*#__PURE__*/transformOrFail({
  ...
  encode: a => Option.match(Duration.toNanos(a), {
    onNone: () => Effect.fail(new Issue.InvalidValue(Option.some(a), {
...
export const urlFromString = /*#__PURE__*/transformOrFail({
  decode: s => Effect.try({
    try: () => new URL(s),
    catch: () => new Issue.InvalidValue(Option.some(s), {
...
export const bigDecimalFromString = /*#__PURE__*/transformOrFail({
  decode: s => {
    ...
    return Option.isNone(result) ? Effect.fail(new Issue.InvalidValue(Option.some(s), {
 ...
 * @since 4.0.0
 */
export const stringFromBase64String = /*#__PURE__*/new Transformation(/*#__PURE__*/Getter.decodeBase64String(), /*#__PURE__*/Getter.encodeBase64());
/**
 ...
 * @since 4.0.0
 */
export const stringFromBase64UrlString = /*#__PURE__*/new Transformation(/*#__PURE__*/Getter.decodeBase64UrlString(), /*#__PURE__*/Getter.encodeBase64Url());
/**
 ...
 * @since 4.0.0
 */
export const stringFromHexString = /*#__PURE__*/new Transformation(/*#__PURE__*/Getter.decodeHexString(), /*#__PURE__*/Getter.encodeHex());
/**
 ...
 * @since 4.0.0
 */
export const stringFromUriComponent = /*#__PURE__*/new Transformation(/*#__PURE__*/Getter.decodeUriComponent(), /*#__PURE__*/Getter.encodeUriComponent());
/**
